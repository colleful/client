...
export const inviteTeam = (teamId, userId, header) =>
  axios.post(`${Config.baseUrl}/api/teams/invitations/${teamId}/${userId}`,{}, header);

export const getInvitationList = (header) => 
  axios.get(`${Config.baseUrl}/api/users/invitations`, header); 

export const acceptInvitation = (invitationId,header) =>
  axios.delete(`${Config.baseUrl}/api/users/invitations/${invitationId}/acceptance`,header);

export const refusalInvitation = (invitationId,header) =>
  axios.delete(`${Config.baseUrl}/api/users/invitations/${invitationId}/refusal`,header);
// auth 관련
