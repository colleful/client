...
export const changeTeamStatus = (body, header) =>
  axios.patch(`${Config.baseUrl}/api/teams`, body, header);
...
export const acceptInvitation = async (id) =>
  ...
  // 근데 만약 body에 정보가 들어가야 된다면? 이것도 해결하기
...
export const deleteInvitation = (id, header) =>
...
export const sendMatching = (body, header) =>
  axios.post(`${Config.baseUrl}/api/matching`, body, header);

export const acceptMatching = (id, body, header) =>
  axios.post(`${Config.baseUrl}/api/matching/${id}/accept`, body, header);

export const refuseMatching = (id, body, header) =>
  axios.post(`${Config.baseUrl}/api/matching/${id}/refuse`, body, header);

export const deleteMatching = (id, header) =>
  axios.delete(`${Config.baseUrl}/api/matching/${id}`, header);
