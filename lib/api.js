...
export const inviteTeam = (teamId, userId, header) =>
  axios.post(
    `${Config.baseUrl}/api/teams/invitations/${teamId}/${userId}`,
    {},
    header,
  );
...
export const acceptInvitation = (invitationId, header) =>
  axios.delete(
    `${Config.baseUrl}/api/users/invitations/${invitationId}/accept`,
    header,
  );

export const refusalInvitation = (invitationId, header) =>
  axios.delete(
    `${Config.baseUrl}/api/users/invitations/${invitationId}/refuse`,
    header,
  );
// auth 관련
