...
export const deleteUser = async () =>
  axios.delete(`${Config.baseUrl}/api/users`, {
    headers: {
      Authorization: await AsyncStorage.getItem('authorization'),
    },
  });
...
export const changeUserInfo = async (body) =>
  axios.patch(`${Config.baseUrl}/api/users`, body, {
    headers: {
      Authorization: await AsyncStorage.getItem('authorization'),
    },
  });
...
export const changeUserPassword = async (body) =>
  axios.patch(`${Config.baseUrl}/api/users/password`, body, {
    headers: {
      Authorization: await AsyncStorage.getItem('authorization'),
    },
  });
...
export const getReadyTeam = async (teamName) =>
  axios.get(`${Config.baseUrl}/api/teams/team-name/${teamName}`, {
    headers: {
      Authorization: await AsyncStorage.getItem('authorization'),
    },
  });
