...
export const acceptInvitation = (id, header) =>
  axios.post(`${Config.baseUrl}/api/invitations/${id}/accept`, header);

export const refuseInvitation = (id, header) =>
  axios.post(`${Config.baseUrl}/api/invitations/${id}/refuse`, header);
