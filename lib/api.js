...
export const acceptInvitation = (invitationId,header) =>
  axios.delete(`${Config.baseUrl}/api/users/invitations/${invitationId}/accept`,header);

export const refusalInvitation = (invitationId,header) =>
  axios.delete(`${Config.baseUrl}/api/users/invitations/${invitationId}/refuse`,header);
// auth 관련
